...
const std::vector<cp_list_item> g_cp_list = {
	cp_list_item("UTF-8", CP_UTF8),

	cp_list_item("ISO-8859-1:1998 (Latin-1, West Europe)", 0, &iso_8859_1),
	cp_list_item("ISO-8859-2:1999 (Latin-2, East Europe)", 0, &iso_8859_2),
	cp_list_item("ISO-8859-3:1999 (Latin-3, South Europe)", 0, &iso_8859_3),
	cp_list_item("ISO-8859-4:1998 (Latin-4, North Europe)", 0, &iso_8859_4),
	cp_list_item("ISO-8859-5:1999 (Latin/Cyrillic)", 0, &iso_8859_5),
	cp_list_item("ISO-8859-6:1999 (Latin/Arabic)", 0, &iso_8859_6),
	cp_list_item("ISO-8859-7:1987 (Latin/Greek)", 0, &iso_8859_7),
	cp_list_item("ISO-8859-8:1999 (Latin/Hebrew)", 0, &iso_8859_8),
	cp_list_item("ISO-8859-9:1999 (Latin-5, Turkish)", 0, &iso_8859_9),
	cp_list_item("ISO-8859-10:1998 (Latin-6, Nordic)", 0, &iso_8859_10),
	cp_list_item("ISO-8859-11:2001 (Latin/Thai)", 0, &iso_8859_11),
	cp_list_item("ISO-8859-13:1998 (Latin-7, Baltic)", 0, &iso_8859_13),
	cp_list_item("ISO-8859-14:1998 (Latin-8, Celtic)", 0, &iso_8859_14),
	cp_list_item("ISO-8859-15:1999 (Latin-9, \"euro\")", 0, &iso_8859_15),
	cp_list_item("ISO-8859-16:2001 (Latin-10, Balkan)", 0, &iso_8859_16),

	cp_list_item("KOI8-U", 0, &koi8_u),
	cp_list_item("KOI8-R", 20866),
	cp_list_item("HP-ROMAN8", 0, &roman8),
	cp_list_item("VSCII", 0, &vscii),
	cp_list_item("DEC-MCS", 0, &dec_mcs),

	cp_list_item("Win1250 (Central European)", 1250),
	cp_list_item("Win1251 (Cyrillic)", 1251),
	cp_list_item("Win1252 (Western)", 1252),
	cp_list_item("Win1253 (Greek)", 1253),
	cp_list_item("Win1254 (Turkish)", 1254),
	cp_list_item("Win1255 (Hebrew)", 1255),
	cp_list_item("Win1256 (Arabic)", 1256),
	cp_list_item("Win1257 (Baltic)", 1257),
	cp_list_item("Win1258 (Vietnamese)", 1258),

	cp_list_item("CP437", 437),
	cp_list_item("CP620 (Mazovia)", 0, &mazovia),
	cp_list_item("CP819", 28591),
	cp_list_item("CP852", 852),
	cp_list_item("CP878", 20866),

	cp_list_item("Use font encoding", -1),
